...
class RoomCapacity(Cost):
    def __init__(self, group_size:int, siting_capacity:int) -> None: 
        ...
        """
        self.limit = 1 # limit for room capacity utilization, set to 100%
        self.sitting_utilization = self.secondary_value / self.primary_value
        self.value = min(100, self.sitting_utilization / (self.limit * 100))
